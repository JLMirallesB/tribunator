...
Tribunator.App = {
  ...
  renderHeader: function() {
    ...
    left.appendChild(Tribunator.Utils.el('div', { className: 'app-title' }, [
      'Tribunator',
      Tribunator.Utils.el('span', { className: 'app-version', textContent: ' v1.2.10' })
    ]));
    ...
    var entries = [
      {
        ...
        date: '2026-06-11',
        changes: {
          es: ['Exportar para Listados: incluye miembros (rol y nombre) y días en tribunales y variaciones'],
          va: ['Exportar per a Llistats: inclou membres (rol i nom) i dies en tribunals i variacions'],
          en: ['Export for Listings: includes members (role and name) and days in tribunals and variations']
        }
      },
      {
        version: '1.2.9',
        date: '2026-06-08',
        changes: {
          es: ['PDF Cartelería: corregida duplicación de tribunales por sala'],
          va: ['PDF Cartelleria: corregida duplicació de tribunals per aula'],
          en: ['PDF Room signs: fixed duplicate tribunals per room']
        }
      },
      {
        version: '1.2.8',
        date: '2026-06-08',
        changes: {
          es: ['PDF Cartelería: secciones Base y variaciones siempre visibles'],
          va: ['PDF Cartelleria: seccions Base i variacions sempre visibles'],
          en: ['PDF Room signs: Base and variation sections always visible']
        }
      },
      {
        version: '1.2.7',
      ...
      },
      {
        ...
        date: '2026-06-08',
        changes: {
          es: ['PDF Cartelería: se muestran las variaciones con sus miembros'],
          va: ['PDF Cartelleria: es mostren les variacions amb els seus membres'],
          en: ['PDF Room signs: variations shown with their members']
        }
      },
      {
        version: '1.2.5',
