    ...
    signRooms.forEach(function(item) {
      ...
      if (occ.length === 0) {
        ...
        occ.forEach(function(o) {
          ...
          // Sections: Base + Variations
          var hasVariations = (trib.variations || []).length > 0;

          // Base section
          if (hasVariations) {
            doc.setFontSize(9); doc.setFont(undefined,'bold'); doc.setTextColor.apply(doc, self.DARK);
            doc.text(t('tribunals.baseComposition'), m + 2, signY + 3);
